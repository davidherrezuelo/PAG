...
function initParticleSystem() {
  ...
  for (var i= 0; i < nParticles; i++) {
    ...
    particleData[i * 10 + 3] = -dx * velocity;  // invertido para que caiga hacia abajo
    particleData[i * 10 + 4] = -dy * velocity;  // invertido para que caiga hacia abajo
    particleData[i * 10 + 5] = -dz * velocity;  // invertido para que caiga hacia abajo
