...
function initShaders() { 
  ...
  gl.enableVertexAttribArray(program.vertexAccelerationAttribute);
...
var nParticles    = 10000*nChorrosParalelos;
...
function initParticleSystem() {
  ...
  for (var i= 0; i < nParticles; i++) {
    ...
    // posicion inicial
    var x = i%nChorrosParalelos/nChorrosParalelos - 0.5;
    var y = 1.15;
    var z = 0.0;
    ...
    var velocity =0.1*((1.25 * alpha) + (1.50 * (1.0 - alpha)));
